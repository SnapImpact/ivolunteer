...
function main() {
  ...
  //App.organizationListController.set('content', App.Organizations.allRecords);
  //App.masterController.set('content', App.Organizations.allRecords) ;
  //App.Organizations.allRecords.refresh();
