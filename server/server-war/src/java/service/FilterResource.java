...
public class FilterResource {
    ...
    public FilterConverter get(@QueryParam("expandLevel")
    @DefaultValue("1")
    int expandLevel) {
    ...
    protected Filter getEntity() {
        ...
        try {
            return (Filter) em.createQuery("SELECT e FROM Filter e where e.id = :id").setParameter("id", id).getSingleResult();
    ...
    protected Filter updateEntity(Filter entity, Filter newEntity) {
        ...
        Collection<OrganizationType> organizationTypeCollectionNew = newEntity.getOrganizationTypeCollection();
    ...
    public OrganizationTypesResource getOrganizationTypeCollectionResource() {
        OrganizationTypeCollectionResourceSub resource = resourceContext.getResource(OrganizationTypeCollectionResourceSub.class);
