...
public class LocationResource {
    ...
    /**
     * Get method for retrieving an instance of Location identified by id in XML format.
     *
    ...
    public LocationConverter get(@QueryParam("expandLevel")
    @DefaultValue("1")
    int expandLevel) {
    ...
    /**
     * Put method for updating an instance of Location identified by id using XML as the input format.
     *
     * @param id identifier for the entity
     * @param data an LocationConverter entity that is deserialized from a XML stream
     */
    @PUT
    ...
    protected Location getEntity() {
        ...
        try {
            return (Location) em.createQuery("SELECT e FROM Location e where e.id = :id").setParameter("id", id).getSingleResult();
