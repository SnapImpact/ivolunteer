...
public class IvUserResource {
    ...
    /**
     * Get method for retrieving an instance of IvUser identified by id in XML format.
     *
    ...
    public IvUserConverter get(@QueryParam("expandLevel")
    @DefaultValue("1")
    int expandLevel) {
    ...
    /**
     * Put method for updating an instance of IvUser identified by id using XML as the input format.
     *
     * @param id identifier for the entity
     * @param data an IvUserConverter entity that is deserialized from a XML stream
     */
    @PUT
    ...
    protected IvUser getEntity() {
        ...
        try {
            return (IvUser) em.createQuery("SELECT e FROM IvUser e where e.id = :id").setParameter("id", id).getSingleResult();
