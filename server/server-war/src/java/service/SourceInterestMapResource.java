...
public class SourceInterestMapResource {
    ...
    /**
     * Get method for retrieving an instance of SourceInterestMap identified by id in XML format.
     *
    ...
    public SourceInterestMapConverter get(@QueryParam("expandLevel")
    @DefaultValue("1")
    int expandLevel) {
        PersistenceService persistenceSvc = PersistenceService.getInstance();
        try {
            persistenceSvc.beginTx();
            return new SourceInterestMapConverter(getEntity(), uriInfo.getAbsolutePath(), expandLevel);
        } finally {
    ...
    /**
     * Put method for updating an instance of SourceInterestMap identified by id using XML as the input format.
     *
     * @param id identifier for the entity
     * @param data an SourceInterestMapConverter entity that is deserialized from a XML stream
     */
    @PUT
    ...
    /**
     * Delete method for deleting an instance of SourceInterestMap identified by id.
     *
     * @param id identifier for the entity
     */
    @DELETE
    ...
    public service.InterestAreaResource getInterestAreaIdResource() {
        InterestAreaIdResourceSub resource = resourceContext.getResource(InterestAreaIdResourceSub.class);
