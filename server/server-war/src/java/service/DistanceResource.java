...
public class DistanceResource {
    ...
    /**
     * Get method for retrieving an instance of Distance identified by id in XML format.
     *
    ...
    public DistanceConverter get(@QueryParam("expandLevel")
    @DefaultValue("1")
    int expandLevel) {
    ...
    /**
     * Put method for updating an instance of Distance identified by id using XML as the input format.
     *
     * @param id identifier for the entity
    ...
    protected Distance getEntity() {
        ...
        try {
            return (Distance) em.createQuery("SELECT e FROM Distance e where e.id = :id").setParameter("id", id).getSingleResult();
