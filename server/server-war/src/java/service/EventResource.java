...
public class EventResource {
    ...
    /**
     * Get method for retrieving an instance of Event identified by id in XML format.
     *
    ...
    public EventConverter get(@QueryParam("expandLevel")
    @DefaultValue("1")
    int expandLevel) {
    ...
    /**
     * Put method for updating an instance of Event identified by id using XML as the input format.
     *
     * @param id identifier for the entity
    ...
    /**
     * Returns a dynamic instance of TimestampsResource used for entity navigation.
     *
     * @param id identifier for the parent entity
    ...
    public TimestampsResource getTimestampCollectionResource() {
        TimestampCollectionResourceSub resource = resourceContext.getResource(TimestampCollectionResourceSub.class);
        resource.setParent(getEntity());
        return resource;
    }
