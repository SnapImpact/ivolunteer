...
public class LocationRecordConverter {
     ...
     */
    public LocationRecordConverter(Location entity, URI uri, int expandLevel, boolean isUriExtendable) {
        this.entity = entity;
    ...
    public Location getEntity() {
        if (entity.getId() == null) {
            LocationRecordConverter converter = UriResolver.getInstance().resolve(LocationRecordConverter.class, uri);
            if (converter != null) {
