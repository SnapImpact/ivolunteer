...
public class SourceInterestMapsConverter {
     ...
     */
    public SourceInterestMapsConverter(Collection<SourceInterestMap> entities, URI uri, int expandLevel) {
     ...
     *
     * @param a collection of SourceInterestMapConverter to set
     */
