...
public class OrganizationRecordConverter {
     ...
     */
    public OrganizationRecordConverter(Organization entity, URI uri, int expandLevel, boolean isUriExtendable) {
        this.entity = entity;
    ...
    public Organization getEntity() {
        if (entity.getId() == null) {
            OrganizationRecordConverter converter = UriResolver.getInstance().resolve(OrganizationRecordConverter.class, uri);
            if (converter != null) {
