...
public class TimeframeRecordConverter {
     ...
     */
    public TimeframeRecordConverter(Timeframe entity, URI uri, int expandLevel, boolean isUriExtendable) {
        this.entity = entity;
     ...
     */
    public TimeframeRecordConverter(Timeframe entity, URI uri, int expandLevel) {
    ...
    public Timeframe getEntity() {
        if (entity.getId() == null) {
            TimeframeRecordConverter converter = UriResolver.getInstance().resolve(TimeframeRecordConverter.class, uri);
            if (converter != null) {
