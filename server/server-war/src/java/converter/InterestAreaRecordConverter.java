...
public class InterestAreaRecordConverter {
     ...
     */
    public InterestAreaRecordConverter(InterestArea entity, URI uri, int expandLevel, boolean isUriExtendable) {
        this.entity = entity;
    ...
    public InterestArea getEntity() {
        if (entity.getId() == null) {
            InterestAreaRecordConverter converter = UriResolver.getInstance().resolve(InterestAreaRecordConverter.class, uri);
            if (converter != null) {
