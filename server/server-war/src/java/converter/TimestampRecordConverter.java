...
public class TimestampRecordConverter {
     ...
     */
    public TimestampRecordConverter(Timestamp entity, URI uri, int expandLevel, boolean isUriExtendable) {
        this.entity = entity;
    ...
    public Timestamp getEntity() {
        if (entity.getId() == null) {
            TimestampRecordConverter converter = UriResolver.getInstance().resolve(TimestampRecordConverter.class, uri);
            if (converter != null) {
